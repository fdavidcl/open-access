...
%\framebox[1.1\width]{\normalsize\textbf{The Annals of Mathematics}\newline \text{hola}} \framebox[1.1\width]{Guess I’m framed now!} 

%\colorbox{black!85}{\makebox[4em]{\strut\textcolor{white}{0.13}}}
%\colorbox{black!85}{\makebox[4em]{\strut\textcolor{white}{1.30}}}
